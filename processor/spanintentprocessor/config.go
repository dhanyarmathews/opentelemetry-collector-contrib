...
// component.NewProcessorSettings(component.NewID("spanintentprocessor"))
//ProcessorSettings:        processor.NewSettings(component.NewID(component.Type(typeStr)))),
// DefaultConfig returns the default configuration for the processor.
/*func DefaultConfig() *Config {
	return &Config{
		Settings:	processor.NewSettings(component.NewID(component.Type(typeStr))),
