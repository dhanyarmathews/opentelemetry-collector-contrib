module github.com/open-telemetry/opentelemetry-collector-contrib-span
...
replace github.com/prometheus/prometheus => github.com/prometheus/prometheus v0.40.5
